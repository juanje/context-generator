...
## `.ai_review/README.md` (Project Scope)

On initial generation or complete regeneration, write a `README.md` alongside the
context file in the `.ai_review/` directory. **ONLY** do this in project scope.
This file explains the folder's purpose to human readers. It is **not** consumed
by the AI reviewer — keep it short.

```markdown
# AI Review Context

Files in this directory are generated by
[context-generator](https://github.com/juanje/context-generator)
and provide project context for
[ai-code-review](https://gitlab.com/redhat/edge/ci-cd/ai-code-review),
an AI-powered code review tool.

These files are AI-generated. Review before committing and edit the manual
sections to capture project knowledge that can't be inferred from code.

Last generated by <host-tool> <host-version> with <model>.
```
...
Write this file on initial generation and complete regeneration, when in project scope.
During section-level or additive updates to the context file, leave an existing `README.md`
unchanged. Do not write this file in team scope.
